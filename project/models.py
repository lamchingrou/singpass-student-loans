...
class Loan_update_history(db.Model):
    ...
    def __init__(self, loan_amount, duration, loan_id, state=LOAN_STATUS['New'], loan_type=LOAN_TYPES['Educational_loan']):
...
class Loan(db.Model):
    ...
    def __init__(self, loan_amount, duration, customer_id, state=LOAN_STATUS['New'], loan_type=LOAN_TYPES['Educational_loan']):
        self.loan_type = loan_type
