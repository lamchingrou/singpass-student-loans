...
class SecurityTests(unittest.TestCase):
    ...
    def test_14_Customer_can_only_view_his_loans(self):
        ...
        '''
        Customner2_loans = [{"loan_amount":10000,"duration":12,"loan_type":"Educational_loan"},
                            {"loan_amount":20000,"duration":24,"loan_type":"Educational_loan"},
                            {"loan_amount":30000,"duration":36,"loan_type":"Educational_loan"}
                            ]
    
        Customner3_loans = [{"loan_amount":10000,"duration":12,"loan_type":"Educational_loan"},
                            {"loan_amount":20000,"duration":24,"loan_type":"Educational_loan"},
                            ]
        try:
            for i in range(3): 
